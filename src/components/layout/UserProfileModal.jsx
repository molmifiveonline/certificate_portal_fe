    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="relative bg-gradient-to-br from-[#3a5f9e] to-[#6fa8dc] px-6 pt-6 pb-10">
                    <button
                        onClick={onClose}
                    ...
                    <div className="flex flex-col items-center">
                        <div className="w-16 h-16 rounded-full bg-white/20 flex items-center justify-center text-white font-bold text-xl shadow-lg ring-3 ring-white/30 mb-3">
                            {profileImage ? (
                                <img
                                    src={profileImage}
                                    alt="User"
                ...
                <div className="px-6 py-4 space-y-3 -mt-4 mx-3 bg-white rounded-xl shadow-sm border border-slate-100">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-sm font-medium text-slate-700 truncate">{user?.email || 'N/A'}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
