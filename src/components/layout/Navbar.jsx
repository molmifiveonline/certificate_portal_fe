        ...
        <div className="flex items-center gap-2 sm:gap-4">
          {canViewNotifications && (
            <button
              ...
              className="relative flex h-10 w-10 items-center justify-center rounded-full border border-[#0060AA] bg-white/60 text-slate-600 shadow-sm transition hover:bg-white hover:text-[#0060AA]"
              title="Notifications"
