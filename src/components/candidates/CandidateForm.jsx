...
const CandidateForm = ({
  ...
  console.log("CandidateForm Debug:", {
    isAdmin,
    showPassword,
    showResetPassword,
  });
          ...
          <div className="flex justify-center mb-10">
            <div className="bg-gray-100 p-1.5 rounded-lg inline-flex">
              <label className="cursor-pointer">
                <input
                  type="radio"
                  value="MOLMI Employee"
                  {...register("employeeType")}
                  className="peer sr-only"
                />
                <span className="px-6 py-2 rounded-md text-sm font-semibold text-gray-500 peer-checked:bg-white peer-checked:text-blue-600 peer-checked:shadow-sm transition-all block">
                  MOLMI Employee
                </span>
              </label>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <InputField
                    label="INDOS No."
                    name="indosNo"
                    placeholder="(For Indian Seafarers)"
          ...
          <div className="mt-10 pt-6 border-t border-gray-100">
            <label className="flex items-start gap-3 cursor-pointer group">
              <div className="relative flex items-center">
                ...
                <svg
                  className="absolute w-3 h-3 text-white left-1 opacity-0 peer-checked:opacity-100 opacity-0 peer-checked:opacity-100 transition-opacity"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="4"
              ...
              <span className="text-sm text-gray-500 group-hover:text-gray-700 leading-relaxed">
                I hereby declare that all the information provided in this form
                is true and can be used by MOLMI for training purposes. This
                information will be subject to data protection as per the MOLMI
