...
const SuperAdminDashboard = () => {
  ...
  const fetchCourses = async (isNewSearch = false) => {
    ...
    try {
      ...
      if (filters.trainer_id && filters.trainer_id !== "all")
        params.trainer_id = filters.trainer_id;
      if (filters.master_course_id && filters.master_course_id !== "all")
        params.master_course_id = filters.master_course_id;
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gradient-to-r from-indigo-900/90 via-blue-900/90 to-indigo-900/90 text-white border-b border-white/10 backdrop-blur-md">
                  ...
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider text-center hidden sm:table-cell">
                    Man Days
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider text-left">
                    Start Date
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider text-left hidden md:table-cell">
                    End Date
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider text-left">
                    Status
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider text-center hidden lg:table-cell">
                    Candidates
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider text-center hidden lg:table-cell">
                    Rating
                ...
                {loadingCourses ? (
                    ...
                    <td colSpan="8" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center justify-center text-slate-400 gap-2">
                        ...
                        <p className="font-medium">
                          Please select a filter and search to view course
                          details
                        </p>
                      </div>
                    </td>
                  ...
                  courses.map((course) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-slate-600 text-center hidden lg:table-cell">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/60 shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gradient-to-r from-indigo-900/90 via-blue-900/90 to-indigo-900/90 text-white border-b border-white/10 backdrop-blur-md">
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider hidden md:table-cell">
                    Candidate ID
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider font-bold">
                    Name
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider">
                    Course Name
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider hidden sm:table-cell">
                    Emp ID
                  </th>
                  <th className="px-6 py-4 text-xs font-bold text-white uppercase tracking-wider text-left">
                    Expiry Date
                  ...
                  expiryAlerts.map((alert, index) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm font-medium text-slate-700 font-mono text-xs hidden md:table-cell">
                        {alert.candidate_id
                          ? alert.candidate_id.substring(0, 8) + "..."
                          : "-"}
                      </td>
