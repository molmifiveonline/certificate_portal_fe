...
import ReportAiChatbotWidget from "./components/ReportAiChatbotWidget";
...
const ReportDashboard = () => {
  ...
  return (
    <div className="relative overflow-hidden p-4 sm:p-6 lg:p-8">
      ...
      <ReportAiChatbotWidget
        activeFilters={{
          feedback: { ...feedbackDates, ...feedbackFilters },
          certificate: { ...certificateDates, ...certificateFilters },
          training_record: { year: trainingRecordYear },
          training_activities: trainingActivitiesForm,
        }}
      />
