...
const EditNominator = () => {
    ...
    useEffect(() => {
        const fetchNominator = async () => {
            try {
                ...
                console.error(error);
                toast.error("Failed to load nominator details");
                navigate('/nominators');
            } finally {
                setLoading(false);
            }
    ...
    const onSubmit = async (data) => {
        ...
        try {
            await nominatorService.updateNominator(id, data);
            toast.success('Nominator updated successfully!');
            navigate('/nominators');
        } catch (error) {
            console.error(error);
            toast.error(error.response?.data?.message || 'Failed to update nominator.');
        } finally {
