...
const AdminRolesList = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            sortable: true,
            render: (val) => (
                <span className={`px-2 py-1 text-[10px] font-bold rounded uppercase ${val === 1 ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'
                    }`}>
            ...
            <Card className="rounded-2xl border-slate-200/60 bg-white/80 backdrop-blur-md shadow-sm mb-8 overflow-visible z-10">
                <CardContent className="p-4 sm:p-6 flex flex-col md:flex-row gap-4 justify-between items-center">
                    ...
                    <div className="flex gap-3 w-full md:w-auto items-center">
                        <span className="text-xs text-slate-400">{totalCount} role{totalCount !== 1 ? 's' : ''}</span>
                    </div>
                </CardContent>
            </Card>
