    ...
    <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in duration-300">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-semibold uppercase tracking-wider">
              {result.assessment_title || "Assessment"}
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white/80 backdrop-blur-xl border-slate-100 shadow-sm">
          <CardContent className="p-6 text-center">
            ...
            <div
              className={`text-4xl font-black ${isPassed ? "text-emerald-500" : "text-rose-500"}`}
            >
              {percentage}%
            </div>
          </CardContent>
        ...
        <Card className="bg-white/80 backdrop-blur-xl border-slate-100 shadow-sm">
          <CardContent className="p-6 text-center">
            ...
            <div
              className={`text-2xl font-bold flex items-center justify-center gap-2 h-10 ${isPassed ? "text-emerald-600" : "text-rose-600"}`}
            >
              {isPassed ? (
      ...
      <Card className="bg-white/80 backdrop-blur-xl border-slate-100 shadow-xl rounded-3xl overflow-hidden">
                ...
                <div className="ml-11 space-y-3">
                  {options.map((opt) => {
                    ...
                    const isCorrect =
                      ...
                      ans.correct_option === opt.key.replace("option_", "opt_");
                    ...
                    return (
                      ...
                      >
                        <span
                          className={`text-base ${optionText} flex items-center gap-3 w-full`}
                        >
                          {opt.img && (
                            <img
        ...
        <CardFooter className="bg-slate-50/50 p-6 flex justify-center border-t border-slate-100">
          <Button
            className="px-10 h-11 text-base font-bold rounded-xl"
            onClick={onClose}
          >
            Close Review
          </Button>
