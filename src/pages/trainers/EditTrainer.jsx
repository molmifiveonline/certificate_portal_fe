    ...
    const fetchTrainer = async () => {
      try {
        ...
        if (trainer.profile_photo) {
          setPreviews((prev) => ({
            ...prev,
            profile_photo: `${process.env.REACT_APP_API_URL}/uploads/trainer/${trainer.profile_photo}`,
          }));
        }
        if (trainer.digital_signature) {
          setPreviews((prev) => ({
            ...prev,
            digital_signature: `${process.env.REACT_APP_API_URL}/uploads/trainer/${trainer.digital_signature}`,
          }));
        }
      } catch (error) {
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className={`w-full h-11 px-4 rounded-xl bg-slate-50/50 border ${errors.password ? "border-red-500" : "border-slate-200"} focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all text-slate-600 text-sm cursor-pointer`}
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    <div className="p-4 border border-dashed border-slate-300 rounded-lg bg-slate-50/50">
                      <FileInput
                        label="Profile Photo (leave empty to keep current)"
                        name="profile_photo"
                      />
                    </div>
                    <div className="p-4 border border-dashed border-slate-300 rounded-lg bg-slate-50/50">
                      <FileInput
                        label="Digital Signature (leave empty to keep current)"
